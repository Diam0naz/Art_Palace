...
const NavBar = () => {
  ...
  return (
    <nav className="bg-dawn-orange/40 text-foreground border-b border-purple-300 font-inter">
      <div className="mx-auto flex max-w-full items-center justify-between gap-6 p-4">   
        ...
        <div className="flex items-center justify-center gap-3">
          <Button
            variant="secondary"
            className="rounded-lg bg-purple-300 text-white/90 gap-1.5 px-5 py-2 hover:bg-purple-400">
            Connect Wallet
